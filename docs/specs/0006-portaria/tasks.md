...
- [ ] **T-1** — Schemas e repositório, com a marcação de uso atômica.
  - Commit: `feat(gate): marcar uso de ingresso de forma atômica`
  - Cobre: RN-3
  - Testes: integração — segunda marcação afeta zero linhas

- [ ] **T-2** — `gate.service.ts` com a ordem das checagens e os quatro
      resultados.
...
- [ ] Rotas novas no `/docs`
- [ ] Checkbox do Épico 6 no backlog, e status no roadmap
